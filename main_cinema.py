...
asientos_ocupados = ["A2", "C1", "D4"]  # Simula la Reserva #882 mencionada
...
# Usamos el primer usuario de tu lista como ejemplo
cliente = usuarios[0] 
...
while True:
    ...
    # Convertimos la entrada "A1, A2" en una lista ["A1", "A2"] limpia
...
total_final, ahorro = aplicar_descuento(monto_inicial)
...
print(f"Total Final: ${total_final:.2f} (Ahorraste ${ahorro:.2f}) pesos")
print("Estado: PAGADA")